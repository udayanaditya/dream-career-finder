        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-600 hover:text-career-purple">Home</Link>
              </li>
              <li>
                <Link to="/quiz" className="text-gray-600 hover:text-career-purple">Take Quiz</Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-600 hover:text-career-purple">Explore Careers</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/login" className="text-gray-600 hover:text-career-purple">Login</Link>
              </li>
              <li>
                <Link to="/register" className="text-gray-600 hover:text-career-purple">Register</Link>
              </li>
            </ul>
          </div>
        </div>
